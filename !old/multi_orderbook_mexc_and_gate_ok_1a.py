...
<body class="bg-gray-900 text-white">
    <div class="container mx-auto p-4">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-lg p-4 mb-4">
            <h1 class="text-2xl font-bold text-center mb-4">🚀 DUAL EXCHANGE ORDERBOOK MONITOR</h1>
            
            <!-- Control Buttons -->
            <div class="flex justify-center gap-4 mb-4">
                <button id="startBtn" class="bg-green-600 hover:bg-green-700 px-6 py-2 rounded font-bold">
                    ▶ START WS
                </button>
                <button id="stopBtn" class="bg-red-600 hover:bg-red-700 px-6 py-2 rounded font-bold">
                    ⏹ STOP WS
                </button>
            </div>
            ...
            <div class="bg-gray-700 border border-gray-600 rounded p-4 mb-4">
                <h3 class="font-bold mb-2">📋 SYMBOL MANAGER</h3>
                <div class="flex flex-wrap gap-4 mb-3" id="symbolCheckboxes"></div>
                <div class="flex gap-2">
                    <input type="text" id="symbolInput" placeholder="Enter symbol (e.g., ADA)" 
                           class="bg-gray-800 border border-gray-600 rounded px-3 py-1 flex-1">
                    <button id="addSymbolBtn" class="bg-blue-600 hover:bg-blue-700 px-4 py-1 rounded">
                        ➕ Add
                    </button>
                    <button id="removeSymbolBtn" class="bg-red-600 hover:bg-red-700 px-4 py-1 rounded">
                        ➖ Remove
                    </button>
                </div>
            </div>
            ...
            <div class="flex justify-center items-center gap-4 mb-4">
                <button id="prevSymbolBtn" class="bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded">
                    ◀ Prev
                </button>
                <div class="text-xl font-bold">
                    Active: <span id="activeSymbol" class="text-yellow-400">NONE</span>
                </div>
                <button id="nextSymbolBtn" class="bg-gray-700 hover:bg-gray-600 px-4 py-2 rounded">
                    Next ▶
                </button>
            </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
                <h2 class="text-xl font-bold text-center mb-4 text-yellow-400">MEXC ORDERBOOK (20 DEPTH)</h2>
                <div class="grid grid-cols-2 gap-2">
                    <!-- MEXC Bids -->
                    <div>
                        <h3 class="font-bold text-green-400 text-center mb-2">BIDS (BUY)</h3>
                        <table class="w-full">
                            <thead>
                    ...
                    <!-- MEXC Asks -->
                    <div>
                        <h3 class="font-bold text-red-400 text-center mb-2">ASKS (SELL)</h3>
                        <table class="w-full">
                            <thead>
                                <tr class="text-xs border-b border-gray-600">
                                    <th>Price</th>
            ...
            <!-- Gate.io Orderbook -->
            <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
                <h2 class="text-xl font-bold text-center mb-4 text-yellow-400">GATE.IO ORDERBOOK (50 DEPTH)</h2>
                <div class="grid grid-cols-2 gap-2">
                    <!-- Gate.io Bids -->
                    <div>
                        <h3 class="font-bold text-green-400 text-center mb-2">BIDS (BUY)</h3>
        ...
        function updateOrderbookDisplay(exchange, symbol) {
            ...
            for (let i = 0; i < maxRows; i++) {
                ...
                if (i < bids.length) {
                    ...
                    cumulativeUsd += priceFloat * quantityFloat;
                    
                    const avgPrice = cumulativeQty > 0 ? (cumulativeUsd / cumulativeQty).toFixed(5) : '0.00000';
                    
                    row.innerHTML = `
                        <td class="bid-price">${parseFloat(price).toFixed(5)}</td>
                        <td class="quantity">${parseFloat(quantity).toFixed(6)}</td>
                        <td class="avg-price">${avgPrice}</td>
                    `;
                } else {
                    row.innerHTML = `
